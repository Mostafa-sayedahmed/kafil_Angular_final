    ...
    if(password == rePassword){
      ...
      .then( async (result) => {
       ...
       await user?.updateProfile({
            ...
            photoURL:"https://firebasestorage.googleapis.com/v0/b/kafiil-12b6c.appspot.com/o/images%2Fuserimage.png?alt=media&token=e88880bd-c2f9-4562-9a72-5628441ad27a",
        }).then(() => {
          this.SetUserData(result.user);
